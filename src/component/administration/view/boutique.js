...
const IndexAdmin=()=>{
    ...
    const setData = function setData(){
        ...
        for(var a=0;a < amazone.length;a++){
            ...
            <div className='row'>
                <ul>
                    <li>{amazone[a].somme+' €'}</li>
                    <li><button onClick={ buttonDelete.bind(this,amazone[a].id)}>
        ...
        for(var a=0;a < virement.length;a++){
            ...
            <div className='row'>
                <ul>
                    <li>{virement[a].somme+' €'}</li>
                    <li><button onClick={ buttonDelete.bind(this,virement[a].id)}>
                            <span className="glyphicon glyphicon-trash" aria-hidden="true"></span>
                        </button>
                    </li>
                </ul>
        ...
        for(var a=0;a < paypal.length;a++){
            ...
            <div className='row'>
                <ul>
                    <li>{paypal[a].somme+' €'}</li>
                    <li><button onClick={ buttonDelete.bind(this,paypal[a].id)}>
                            <span className="glyphicon glyphicon-trash" aria-hidden="true"></span>
                        </button>
                    </li>
                </ul>
    ...
    return (
            <div> 
                ...
                <div className='container-admin' data-aos="fade-left">
                    <div id='titre-admin' >
                        <h1><span className="glyphicon glyphicon-shopping-cart"  aria-hidden="true"></span><b>Boutique</b></h1>
                      
                    </div>
                        <div id='response' className='fade_up boutique-view-admin'>
                            {loader()}
                        </div>
